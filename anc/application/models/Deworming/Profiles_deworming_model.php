...
class Profiles_deworming_model extends CI_Model {
    ...
    var $column_order = array('deworming_id','period','year','date','encoded',null); //set 

    var $column_search = array('deworming_id','period','year','date','encoded'); //set column field database for datatable searchable just firstname , lastname , address are searchable
