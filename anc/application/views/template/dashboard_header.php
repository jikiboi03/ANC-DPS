...
<html lang="en">
  <head>
    ...
    <title>ANC | Data Profiling System
    </title>
    <!--STYLESHEET-->
    <!--=================================================-->
          ...
          <div id="navbar-container" class="boxed">
            ...
            <div class="navbar-header">
              <a href="<?php echo base_url();?>dashboard" class="navbar-brand">
                <img src="<?php echo base_url();?>assets/img/logo.png" alt="ANC - DPS" class="brand-icon" style="width: 30px; height: 30px; margin-left: 20px; margin-top: 12px;">
                <div class="brand-title">
                  <span class="brand-text" style="margin-left: 12px;">A N C - D P S
                  </span>
