...
<head>
	...
	<title>Login page | ANC-DPS (Archdiocesan Nourishment Center Data Profiling System)</title>
	<!--STYLESHEET-->
	<!--=================================================-->
	...
	<style>
		.demo-my-bg{
			background-image : url("assets/img/children1.jpg");
		}
	</style>
		...
		<div class="cls-header cls-header-lg">
			<div class="cls-brand">
				<a class="box-inline" href="index.html">
					...
					<span class="brand-title">ANC-DPS | <span class="text-thin">Archdiocesan Nourishment Center Data Profiling System</span></span>
				</a>
			</div>
		</div>
		<!--===================================================-->
