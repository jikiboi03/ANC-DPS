            ...
            <div id="content-container">
                ...
                <div id="page-content">
                    ...
                    <!--===================================================-->
                    <!-- End Striped Table -->
                    <span>&nbsp; <i style = "color: #cccccc;" class="fa fa-square"></i> - Normal Users &nbsp; | &nbsp; <i style = "color: #66ffff;" class="fa fa-square"></i> - Administrators &nbsp; | &nbsp; <i style = "color: #ffff66;" class="fa fa-square"></i> - Super Administrator</span>
                </div>
                <!--===================================================-->
                <!--End page content-->
            </div>
