            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Barangays List</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                <!--Page content-->
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Barangays Information Table</h3>
                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body form">
                            <form action="#" id="form" class="form-horizontal">
                                ...
                                <input type="hidden" value="" name="barangay_id"/> 
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="name" placeholder="Barangay Name" class="form-control" type="text">
