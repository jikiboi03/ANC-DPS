            ...
            <div id="content-container">
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <table id="schedules-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th style="width:60px;">SchedID</th>
                                        <th>Title</th>
                                        <th>Date</th>
                                        <th>Time</th>
                                        <th>Remarks</th>
                    ...
                    <!--===================================================-->
                    <!-- End Striped Table -->
                    <span>&nbsp; <i style = "color: #99ff99;" class="fa fa-square"></i> - Today &nbsp; | &nbsp; <i style = "color: #cccccc;" class="fa fa-square"></i> - Ended &nbsp; | &nbsp; <i style = "color: #ffffff;" class="fa fa-square"></i> - Incoming</span>
                </div>
                <!--===================================================-->
                <!--End page content-->
            </div>
