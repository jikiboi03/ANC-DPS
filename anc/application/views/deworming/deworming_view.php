            ...
            <div id="content-container">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Deworming List</li>
                </ol>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End breadcrumb-->
                <!--Page content-->
                ...
                <div id="page-content">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">Deworming Logs Table</h3>
                        </div>

                        <div class="panel-body">
                            <button class="btn btn-success" onclick="add_deworming()"><i class="fa fa-plus-square"></i> &nbsp;Add Deworming Record</button>
                            <button class="btn btn-default" onclick="reload_table()"><i class="fa fa-refresh"></i> &nbsp;Reload</button>
                            <br><br>
                            <table id="deworming-table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
